...
private static List<Actor> GetAllActors(object parent)
{
    ...
    return actors;
        ...
        /// </summary>
        public static Task<bool> DisplayPicture(string path, float duration, string animation, bool toQueue, bool cleanbg)
        { 
            return Task.Run(() =>
            {
                try
                            ...
                            case "display":
                                switch (urlParts[3])
                                {
                                    case "picture":
                                        ...
                                        bool sucess = DisplayPicture(picturepath, pictureduration, pictureanimation, queue, pcleanbg).Result;
                                        if (!sucess)
                                        {
